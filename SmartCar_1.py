...
camera = PiCamera()
camera.resolution = (360, 200)
camera.rotation = 180
camera.framerate = 15
rawCapture = PiRGBArray(camera, size=(360, 200))
time.sleep(0.1)
...
def find_marker(image):
    ...
    circles = cv2.HoughCircles(gray, cv2.cv.CV_HOUGH_GRADIENT, 0.5, 100)
    a=()
